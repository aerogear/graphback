...
export const createTemplate = (subscription: boolean, fieldName: string, tableName: string, typeName: string): string => {
    if(subscription) {
...
export const deleteTemplate = (subscription: boolean, fieldName: string, tableName: string, typeName: string): string => {
    if(subscription) {  
...
export const updateTemplate = (subscription: boolean, fieldName: string, tableName: string, typeName: string): string => {
    if(subscription) {
      return `${fieldName}: (_: any, args: any, context: GraphQLContext) => {
