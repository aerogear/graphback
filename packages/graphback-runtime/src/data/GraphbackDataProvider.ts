...
// Interface defining the offset and limit for pagination
...
export interface GraphbackDataProvider<Type = any, GraphbackContext = any> {
  ...
  /**
   * Implementation for reading paginated data
   *
   * @param name name of the to create
   * @param paginate containing start and limit parameters
   * @param context context object passed from graphql or rest layer
   */
